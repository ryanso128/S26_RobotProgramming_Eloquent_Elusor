...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor','blue',ParameterDescriptor(description='Sets the turtle display color at startup'))
        self.declare_parameter('penSize',3,ParameterDescriptor(description='Sets the turtle pen size at startup'))
