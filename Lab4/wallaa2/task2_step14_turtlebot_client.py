...
class TurtleClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('turtleColor', 'black', ParameterDescriptor(description='The color of the turtle pen')) # set default color to black
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)

        #### call SetColor service to set the pen color ####
        ...
        #### declare pen size parameter ####
        self.declare_parameter('penSize', 1, ParameterDescriptor(description='The turtle line width')) # set default value to 1, must be an integer
