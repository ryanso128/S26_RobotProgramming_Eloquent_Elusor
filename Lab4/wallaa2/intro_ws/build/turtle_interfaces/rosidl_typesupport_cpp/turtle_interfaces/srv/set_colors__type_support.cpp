...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_interfaces, srv, SetColors)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<turtle_interfaces::srv::SetColors>();
}
