...
#include "intro_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const intro_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  intro_interfaces::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = intro_interfaces::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const intro_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<intro_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &intro_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, intro_interfaces, msg, Sphere)() {
  return &intro_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
