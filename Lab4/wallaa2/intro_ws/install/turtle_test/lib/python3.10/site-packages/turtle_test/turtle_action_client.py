...
class TurtleSquareClient(Node):
    def __init__(self):
        ...
        size = ParameterDescriptor(description='The square size to draw')
        self.declare_parameter('square_size', 'world', size)
    ...
    def send_goal(self):
        ...
        goal_msg.square_size = self.get_parameter('square_size').get_parameter_value().string_value
