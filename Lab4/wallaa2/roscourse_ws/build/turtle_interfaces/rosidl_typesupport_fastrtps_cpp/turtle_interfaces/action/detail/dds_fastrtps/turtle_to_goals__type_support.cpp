  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::action::TurtleToGoals_Goal;
    is_plain =
      (
      offsetof(DataType, goal_poses) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _TurtleToGoals_Goal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_Goal(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_Result;
    is_plain =
      (
...
static size_t _TurtleToGoals_Result__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_Result(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_Feedback;
    is_plain =
      (
      offsetof(DataType, mid_goal_pose) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _TurtleToGoals_Feedback__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_Feedback(full_bounded, is_plain, 0);
...
// functions for turtle_interfaces::action::TurtleToGoals_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_SendGoal_Request;
    is_plain =
      (
...
static size_t _TurtleToGoals_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_SendGoal_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_SendGoal_Response;
    is_plain =
      (
...
static size_t _TurtleToGoals_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_SendGoal_Response(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_GetResult_Request;
    is_plain =
      (
...
static size_t _TurtleToGoals_GetResult_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for turtle_interfaces::action::TurtleToGoals_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_GetResult_Response;
    is_plain =
      (
...
static size_t _TurtleToGoals_GetResult_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for turtle_interfaces::action::TurtleToGoals_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces::action::TurtleToGoals_FeedbackMessage;
    is_plain =
      (
...
static size_t _TurtleToGoals_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_TurtleToGoals_FeedbackMessage(full_bounded, is_plain, 0);
