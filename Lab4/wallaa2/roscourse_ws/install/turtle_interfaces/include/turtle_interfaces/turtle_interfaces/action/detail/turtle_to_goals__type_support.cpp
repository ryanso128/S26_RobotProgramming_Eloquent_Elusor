...
void fetch_function__TurtleToGoals_Goal__goal_poses(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Pose *>(
    get_const_function__TurtleToGoals_Goal__goal_poses(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Pose *>(untyped_value);
  value = item;
}

void assign_function__TurtleToGoals_Goal__goal_poses(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Pose *>(
    get_function__TurtleToGoals_Goal__goal_poses(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TurtleToGoals_Goal_message_member_array[1] = {
  {
    ...
    fetch_function__TurtleToGoals_Goal__goal_poses,  // fetch(index, &value) function pointer
    assign_function__TurtleToGoals_Goal__goal_poses,  // assign(index, value) function pointer
