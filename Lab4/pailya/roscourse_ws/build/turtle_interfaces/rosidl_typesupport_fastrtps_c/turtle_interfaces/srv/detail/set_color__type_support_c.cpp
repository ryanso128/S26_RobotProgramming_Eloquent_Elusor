  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__srv__SetColor_Request;
    is_plain =
      (
...
static size_t _SetColor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__srv__SetColor_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__srv__SetColor_Response;
    is_plain =
      (
...
static size_t _SetColor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__srv__SetColor_Response(
    full_bounded, is_plain, 0);
