  ...
  void * untyped_ros_message)
{
  ...
  // Field name: goal_poses
  {
    ...
    if (!geometry_msgs__msg__Pose__Sequence__init(&ros_message->goal_poses, size)) {
      fprintf(stderr, "failed to create array for field 'goal_poses'");
      return false;
    }
    auto array_ptr = ros_message->goal_poses.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__action__TurtleToGoals_Goal;
    is_plain =
      (
...
static size_t _TurtleToGoals_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_Result;
    is_plain =
      (
...
static size_t _TurtleToGoals_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_Feedback;
    is_plain =
      (
...
static size_t _TurtleToGoals_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_SendGoal_Request;
    is_plain =
      (
...
static size_t _TurtleToGoals_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_SendGoal_Response;
    is_plain =
      (
...
static size_t _TurtleToGoals_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_GetResult_Request;
    is_plain =
      (
...
static size_t _TurtleToGoals_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_GetResult_Response;
    is_plain =
      (
...
static size_t _TurtleToGoals_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__action__TurtleToGoals_FeedbackMessage;
    is_plain =
      (
...
static size_t _TurtleToGoals_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__action__TurtleToGoals_FeedbackMessage(
    full_bounded, is_plain, 0);
