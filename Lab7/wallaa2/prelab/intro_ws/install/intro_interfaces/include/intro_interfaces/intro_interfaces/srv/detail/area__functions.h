...
#ifndef INTRO_INTERFACES__SRV__DETAIL__AREA__FUNCTIONS_H_
#define INTRO_INTERFACES__SRV__DETAIL__AREA__FUNCTIONS_H_
...
/// Create srv/Area message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * intro_interfaces__srv__Area_Request__init().
...
/// Destroy srv/Area message.
/**
 * It calls
 * intro_interfaces__srv__Area_Request__fini()
...
/// Check for srv/Area message equality.
/**
...
/// Initialize array of srv/Area messages.
/**
...
/// Finalize array of srv/Area messages.
/**
 * It calls
 * intro_interfaces__srv__Area_Request__fini()
...
/// Create array of srv/Area messages.
/**
 * It allocates the memory for the array and calls
 * intro_interfaces__srv__Area_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Area messages.
/**
 * It calls
 * intro_interfaces__srv__Area_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Area message array equality.
/**
...
/// Copy an array of srv/Area messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * intro_interfaces__srv__Area_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_intro_interfaces
...
/**
 * It calls
 * intro_interfaces__srv__Area_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_intro_interfaces
...
/**
 * It allocates the memory for the array and calls
 * intro_interfaces__srv__Area_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_intro_interfaces
...
/**
 * It calls
 * intro_interfaces__srv__Area_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTRO_INTERFACES__SRV__DETAIL__AREA__FUNCTIONS_H_
